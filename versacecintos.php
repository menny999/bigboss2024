...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="VERSACE IMG/Kategorie-Banner.jpg" class="d-block w-100" alt="Banner 1">
      <!-- Ajusta el atributo alt con una descripción adecuada -->
    </div>
    <div class="carousel-item">
      <img src="VERSACE IMG/Kategorie-Banner.jpg" class="d-block w-100" alt="Banner 2">
    </div>
    <div class="carousel-item">
      <img src="VERSACE IMG/Kategorie-Banner.jpg" class="d-block w-100" alt="Banner 2">
    </div>
  ...
  <li>
    ...
    <li>
      ...
      <div class="dropdown clearfix">
        <ul>
          <li><a>Mas</a></li>
          <li><a href="versace.php">Prendas</a></li>
          <li><a href="versacecalzado.php">Calzado</a></li>
        </ul>
        <ul>
        <li><a>Accesorios</a></li>
          <li><a href="versacejoyeria.php">Joyeria</a></li>
          <li><a href="versaceperfumes.php">Perfumes</a></li>
          <li><a href="versacecintos.php">Cintos</a></li>
        </ul>
    </li>
...
<div class="container">
  <div class="productos">
    <?php
    $productos = array(
      array("CINTURÓN BAROCCO LA MEDUSA", "MX $35,000", "CINTOSVERSACE/CINTURÓN BAROCCO LA MEDUSA.avif", array("CINTOSVERSACE/CINTURÓN BAROCCO LA MEDUSA.avif", "CINTOSVERSACE/CINTURÓN BAROCCO LA MEDUSA2.avif"), array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL CON CRISTALES LA MEDUSA", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL CON CRISTALES LA MEDUSA.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL CON CRISTALES LA MEDUSA.avif", "CINTOSVERSACE/CINTURÓN DE PIEL CON CRISTALES LA MEDUSA2.avif"), array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL GRECA", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL GRECA.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL GRECA.avif", "CINTOSVERSACE/CINTURÓN DE PIEL GRECA2.avif"),  array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL LA MEDUSA GRECA", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA GRECA.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA GRECA.avif", "CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA GRECA2.avif"),  array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL LA MEDUSA", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA.avif", "CINTOSVERSACE/CINTURÓN DE PIEL LA MEDUSA2.avif"),  array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL REVERSIBLE BAROCCO", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE BAROCCO.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE BAROCCO.avif", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE BAROCCO2.avif"), array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL REVERSIBLE LA MEDUSA", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE LA MEDUSA.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE LA MEDUSA.avif", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE LA MEDUSA2.avif"),  array("38", "40", "42", "44", "46", "48", "50")),
      array("CINTURÓN DE PIEL REVERSIBLE MEDUSA BIGGIE", "MX $31,300", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE MEDUSA BIGGIE.avif", array("CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE MEDUSA BIGGIE.avif", "CINTOSVERSACE/CINTURÓN DE PIEL REVERSIBLE MEDUSA BIGGIE2.avif"),  array("38", "40", "42", "44", "46", "48", "50")),
    ...
    foreach ($productos as $index => $producto) {
      ...
      foreach ($tallas as $talla) {
        echo '<li onclick="seleccionarTalla(\'' . htmlspecialchars($talla) . '\')">' . htmlspecialchars($talla) . '</li>';
    } 
      echo '</ul></div>';
...
<header>
<p>&copy; Versace. Derechos reservados.</p>
</header>
