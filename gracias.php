...
<body>
    <div class="container text-center" id="content">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $precioTotal = isset($_POST['precio_total']) ? $_POST['precio_total'] : '';
            ...
            echo '<p><strong>Productos:</strong> ' . htmlspecialchars($nombreProducto) . '</p>';
            echo '<p><strong>Total:</strong> ' . htmlspecialchars($precioTotal) . '</p>';
            echo '<p><strong>Método de pago:</strong> Tarjeta ' . htmlspecialchars($metodoPago) . '</p>';
